                        ...
                        if (!(isNaN(i) || i <= 0)) {
                            switch (e) {
                                default:
                                    ...
                                    break;
                                case "triangle":
                                    t.beginPath(), d = (a = 3 * i / Math.sqrt(3)) * Math.sqrt(3) / 2, t.moveTo(n - a / 2, o + d / 3), t.lineTo(n + a / 2, o + d / 3), t.lineTo(n, o - 2 * d / 3), t.closePath(), t.fill();
                                    break;
                                case "rect":
                                    c = 1 / Math.SQRT2 * i, t.beginPath(), t.fillRect(n - c, o - c, 2 * c, 2 * c), t.strokeRect(n - c, o - c, 2 * c, 2 * c);
                                    break;
                                case "rectRot":
                                    c = 1 / Math.SQRT2 * i, t.beginPath(), t.moveTo(n - c, o), t.lineTo(n, o + c), t.lineTo(n + c, o), t.lineTo(n, o - c), t.closePath(), t.fill();
                                    break;
                                case "cross":
...
function (s, l, t) {
    s.fn.easyEmbed = function (t) {
        var i = this,
            ...
            a = function () {
                i.html(s("<iframe>").attr("src", function () {
                ...
                }()).attr("width", "100%").attr("height", "100%").attr("frameborder", 0).attr("allowfullscreen", 1)), i.addClass("playing-video")
            };
        return o(), s(l).resize(function () {
            o()
        }), e ? a() : (! function (i) {
            switch (r.provider.toLowerCase()) {
                case "youtube":
                    ...
                    ! function t() {
                        var e;
                        e = "auto" == r.thumbnail ? n + o[0] + ".jpg" : r.thumbnail, s("<img/>").attr("src", e).on("load", function () {
                            120 != this.width && 90 != this.height ? i(e) : (o.shift(), t())
                        })
                    }();
                    break;
                case "vimeo":
                    s.get("https://vimeo.com/api/oembed.json?url=http://vimeo.com/" + r.id, function (t) {
                        i(t.thumbnail_url)
                    });
                    break;
                case "twitch":
                    n = "//static-cdn.jtvnw.net/previews-ttv/live_user_" + r.id + "-", o = ["320x180"],
                        function t() {
                            var e;
                            e = "auto" == r.thumbnail ? n + o[0] + ".jpg" : r.thumbnail, s("<img/>").attr("src", e).on("load", function () {
                                120 != this.width && 90 != this.height ? i(e) : (o.shift(), t())
            ...
            var e;
            e = t, i.css("background", "black url(" + e + ") 50% 50% / cover no-repeat")
        }), i.find("*").addBack().click(function () {
            a()
        })), this
    }, s(t).ready(function () {
        0 < s("[data-easy-embed]").length && s("[data-easy-embed]").each(function () {
            s(this).easyEmbed()
        })
    })
}